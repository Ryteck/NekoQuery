...
type RootInputVariants = VariantProps<typeof RootInputStyles>;

interface RootInputComponentProps extends ComponentProps<"div"> {
...
type LabelInputVariants = VariantProps<typeof LabelInputStyles>;

interface LabelInputComponentProps extends ComponentProps<"label"> {
...
type CoreInputVariants = VariantProps<typeof CoreInputStyles>;

interface CoreInputComponentProps extends ComponentProps<"div"> {
...
type PrefixIconInputVariants = VariantProps<typeof PrefixIconInputStyles>;

interface PrefixIconInputComponentProps extends ComponentProps<"span"> {
...
type InputInputVariants = VariantProps<typeof InputInputStyles>;

interface InputInputComponentProps extends ComponentProps<"input"> {
...
type ActionIconInputVariants = VariantProps<typeof ActionIconInputStyles>;

interface ActionIconInputComponentProps extends ComponentProps<"button"> {
...
type ErrorMessageInputVariants = VariantProps<typeof ErrorMessageInputStyles>;

interface ErrorMessageInputComponentProps extends ComponentProps<"p"> {
